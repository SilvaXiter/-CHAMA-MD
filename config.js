...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "CHAMA-MD=2YFHCAoK#QzEgI9MroJEjUmKZoRIdEkwVtFKYJEXd6td7MYdEb1w",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY SILVA-MD 🤍*",
...
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *SILVA-MD*⚡",
// add alive msg here 
